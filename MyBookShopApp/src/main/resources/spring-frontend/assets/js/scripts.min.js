...
(function ($) {
    ...
    $(function () {
        ...
        var Login = function () {
            ...
            var $entryLoginPassButton = $('button[name="toComeInLoginPass"]');
                ...
                init: function () {
                    ...
                    $('.Login-type input').on('change', function () {
                        ...
                        if ($this.attr("name") === 'typeauth') {
                            switch ($this.val()) {
                                case'phonetype':
                                    $('.form-group_phonemail').removeClass('form-input_hide').prop('disabled', false);
                                    $phone.removeClass('form-input_hide').prop('disabled', false);
                                    $('.form-group_loginpass').addClass('form-input_hide').prop('disabled', true);
                                    $mail.addClass('form-input_hide').prop('disabled', true);
                                    $sendButton.attr('data-send', 'phone');
                                    break;
                                case'mailtype':
                                    $('.form-group_phonemail').removeClass('form-input_hide').prop('disabled', false);
                                    ...
                                    $sendButton.attr('data-send', 'mail');
                                    break;
                                case'loginpasstype':
                                    $('.form-group_loginpass').removeClass('form-input_hide').prop('disabled', true);
                                    $('.form-group_phonemail').addClass('form-input_hide').prop('disabled', true);
                                    break;
                            }
                        }
                    });
                    ...
                    $entryLoginPassButton.on('click', function (e) {
                        e.preventDefault();
                        var $this = $(this);
                        var $thisStep = $this.closest($LoginStep), $validate = $thisStep.find('[data-validate]'),
                            error = false;
                        ...
                        if ($this.is('[data-send]')) {
                            if (!error) {
                                var login = $('.form-input_login').val();
                                var password = $('.form-input_password').val();
                                $this.data('send', {login: login, password: password});
                ...
                init: function () {
                            ...
                            if (result.result) {
                                ...
                                if ($cart.length) {
                                    ...
                                    $cart.find('.Cart-product').each(function () {
                                        ...
                                        if (typeof $this.find('[data-sendstatus="KEPT"]') == undefined) {
                                            booksId.push($this.find('[data-sendstatus="KEPT"]').data('bookid'));
                                        }
                                        if (typeof $this.find('[data-sendstatus="CART"]' === undefined)) {
                                    ...
                                    if ($cart.hasClass('Cart_postponed') || $cart.hasClass('Cart_buy')) {
                                        $cart.find('.Cart-buyAll').attr('data-bookid', '[' + booksId + ']');
                                    }
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/rateBook', {
                            ...
                            var value = $this.val();
                            for (var i = 1; i <= 5; i++) {
                                var $ratingStar = $('.Rating-star_' + i)
                                if (value < i) {
                                    $ratingStar.removeClass('Rating-star_view');
                                } else {
                                    $ratingStar.addClass('Rating-star_view');
                                }
                            }
                                ...
                                if ($(slick.$slides[slick.$slides.length - 3]).hasClass('slick-active')) {
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        function sendData(address) {
                                            getData(address, {
                                                offset: function () {
                                                    $(slick.$slider).data('loadoffset', ($(slick.$slider).data('loadoffset') + $(slick.$slider).data('loadlimit')));
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            ...
                                            case'popular':
                                                ...
                                                break;
                                            case'author':
                                                sendData('/books/author/' + $(slick.$slider).data('loadid'))
                                                break;
                                        }
                                    }
                                }
